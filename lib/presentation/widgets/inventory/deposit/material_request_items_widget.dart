...
class MaterialRequestItemsWidget extends StatefulWidget {
  final MaterialRequestDepositData depositData;
  final List<SelectableDepositItem> selectedItems;
  final Function(List<SelectableDepositItem>) onItemsChanged;

  const MaterialRequestItemsWidget({
    Key? key,
  ...
  @override
  State<MaterialRequestItemsWidget> createState() => _MaterialRequestItemsWidgetState();
}

class _MaterialRequestItemsWidgetState extends State<MaterialRequestItemsWidget> {
  String _searchQuery = '';
  ...
  Widget _buildHeader() {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.assignment, color: Colors.orange, size: 20.sp),
          SizedBox(width: 8.w),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Select items from material requests',
                  style: TextStyle(
                    color: Colors.orange,
                    fontSize: 12.sp,
                  ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (item.metadata['material_request'] != null)
                        Text(
                          'MR: ${item.metadata['material_request']}',
                          style: TextStyle(
                            fontSize: 12.sp,
                            color: Colors.grey[600],
                          ),
                        ),
                      if (item.metadata['required_by_date'] != null)
                        Text(
                          'Required by: ${item.metadata['required_by_date']}',
                          style: TextStyle(
                            fontSize: 12.sp,
