...
class VerifyBookingCreatePage extends StatefulWidget {
  ...
  @override
  State<VerifyBookingCreatePage> createState() => _VerifyBookingCreatePageState();
}

class _VerifyBookingCreatePageState extends State<VerifyBookingCreatePage> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<OfflineDeliveryBloc, OfflineDeliveryState>(
      listener: (context, state) {
        if (state is VerificationCreated) {
