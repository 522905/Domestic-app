  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: PopupMenuButton<PageFilter>(
          ...
          child: Text.rich(TextSpan(
            children: [
              TextSpan(text: pageTitle, style: TextStyle(color: Colors.black87)),
      ...
      body: RefreshIndicator(
        ...
        child: Column(
          children: [
            if (widget.headlessService.tabs.isNotEmpty == true)
              _buildCustomTabs(),
            Expanded(
                    ...
                    children: [
                      ...
                      NotificationTile(
                        ...
                        onTap: (notification) async {
                          ...
                          if (notification.redirect?.url != null && notification.redirect!.url!.isNotEmpty) {
                            if (!mounted) return;
                            // Use company-aware navigation
                            await AppRoutes.navigateWithCompanyCheck(context, notification.redirect!.url!);
                          }
